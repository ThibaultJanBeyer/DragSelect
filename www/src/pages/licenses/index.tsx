  ...
  return (
    <>
      ...
      <main>
        ...
        <p>
          If you are creating an open source application under a license compatible with the <a href="https://www.gnu.org/licenses/gpl-3.0.html">GNU GPL license v3</a>, you may use this project under the terms of the GPLv3. Questions? Read the <a href="https://www.gnu.org/licenses/gpl-faq.html#GPLRequireSourcePostedPublic">GPL FAQ</a>. or this <a href="https://greendrake.info/publications/js-gpl">blog post</a>. Basically, if your project is not commercial, no need to worry.
        </p>
        <h2 className={styles.section__title}>
          Student discount
        </h2>
        <p>
          If you are a student currently enrolled in a College or University, write me via <a href="mailto:thibault.beyer@gmail.com">thibault.beyer@gmail.com</a> to get a free license.
        </p>
        <h2 className={styles.section__title}>
        ...
        <p>
          Please find the key points of the commercial license below. If you have any more questions, please contact at <a href="mailto:thibault.beyer@gmail.com">thibault.beyer@gmail.com</a>
        </p>
        <h3 className={styles.section__subTitle}>
          Team member
        </h3>
        <p>
          Commercial licenses are priced per team member. A team member is an individual person permitted to make modifications for your applications that uses DragSelect, whether such person is your employee or a consultant or contractor providing services to you.
        </p>
        <h3 className={styles.section__subTitle}>
          Free updates
        </h3>
        ...
        <p>
          DragSelect cannot be used in a product offered for sale, where DragSelect contributes to the core value of the product being sold. If you like to build something based on DragSelect such as a pro WordPress plugin for DragSelect, please reach out to us at <a href="mailto:thibault.beyer@gmail.com">thibault.beyer@gmail.com</a>. 
          DragSelect may not be used for re-selling, sub-licensing, or sharing purposes, and cannot otherwise be redistributed on its own (even for free).
        </p>
        <h3 className={styles.section__subTitle}>
          Unlimited time
        </h3>
