...
<a href="https://github.com/ThibaultJanBeyer/DragSelect/actions">
  ...
  <img
    alt="gzip size"
    src="https://img.badgesize.io/https://unpkg.com/dragselect@latest/dist/ds.min.js?compression=gzip"
  />
...
- Lightweight, only ![gzip size](https://img.badgesize.io/https://unpkg.com/dragselect@latest/dist/ds.min.js?compression=gzip)
