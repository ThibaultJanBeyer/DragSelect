...
| `selector`            | HTMLElement &#124; any                                | Is Auto-Created              | The square that will draw the selection. By default it will create one for you
| `selectorArea`        | HTMLElement &#124; any                                | Is Auto-Created              | The element in which the selector will be placed. It is recommended to have a `position:absolute` on that element. By default it will create one for you.
...
new DragSelect({
  ...
  selectorArea: document.querySelector('#selector-area'),
