...
|--- |--- |
|[BrowserStack](https://www.browserstack.com/) is an amazing testing service which helps testing the tool on various browsers. They support this open source projects by providing a [free account for open source projects](https://www.browserstack.com/open-source) to use their service! | [Direct Donations](https://paypal.me/kleinanzeigen3) (will be linked here & distributed with all contributers proportionally) or [Get in touch](mailto:thibault.beyer@gmail.com) |
